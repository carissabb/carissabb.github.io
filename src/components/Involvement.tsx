              ...
              <div key={idx} className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
                <h3 className="text-lg font-semibold text-gray-900">{involvement.title}</h3>
                        <div className="px-4 py-2">
                            <h3 className="text-sm font-semibold leading-6 text-gray-900"><em>{involvement.role}</em></h3>
                            <p className="text-sm text-gray-500">{involvement.period}</p>
                        </div>
                    <p className="text-sm text-gray-500">{involvement.association} | {involvement.location}</p>
